...
public class Optimizer {
    ...
    public void initGraph(List<Track> tracks, List<View> views) {
        ...
        // TODO compare to the previous version. I think this modication fixes a bug
        //      isLocal would be set to true at the first local track then all after that would be local
        //      I believe the new behavior is correct
